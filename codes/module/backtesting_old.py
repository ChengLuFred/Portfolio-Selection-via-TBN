...
class vectorized_backtesting:
    ...
    def load_data(self):
        ...
        # load company key
        file_path = '/Users/cheng/Google Drive/PhD/Research/Portfolio Selection via TBN/data/Data/gvkey_ticker.csv'
        company_key = pd.read_csv(file_path,  header=0, usecols=[1, 2], index_col = [0], engine='c')
        ...
        # load stock price
        file_path = '/Users/cheng/Google Drive/PhD/Research/Portfolio Selection via TBN/data/Data/stock_data.csv'
        stock_price = pd.read_csv(file_path,  header=0, index_col=[0], engine='c')
        ...
        # load TBN data
        file_path = '/Users/cheng/Google Drive/PhD/Research/Portfolio Selection via TBN/data/TBN/sample_company_30/'
        file_type = 'TBN_*.csv'
